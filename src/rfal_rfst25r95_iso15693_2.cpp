...
******************************************************************************
*/
ReturnCode RfalRfST25R95Class::iso15693PhyConfigure(const iso15693PhyConfig_t *config, const struct iso15693StreamConfig **needed_stream_config)
{
...
ReturnCode RfalRfST25R95Class::iso15693PhyGetConfiguration(iso15693PhyConfig_t *config)
{
...
ReturnCode RfalRfST25R95Class::iso15693VCDCode(uint8_t *buffer, uint16_t length, bool sendCrc, bool sendFlags, bool picopassMode,
...
ReturnCode RfalRfST25R95Class::iso15693VICCDecode(const uint8_t *inBuf,
                                                  uint16_t inBufLen,
                                                  uint8_t *outBuf,
                                                  uint16_t outBufLen,
                                                  uint16_t *outBufPos,
