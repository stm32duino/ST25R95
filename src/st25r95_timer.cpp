...
/*******************************************************************************/
uint32_t RfalRfST25R95Class::timerCalculateTimer(uint16_t time)
{
  return (millis() + time);
}
...
/*******************************************************************************/
bool RfalRfST25R95Class::timerIsExpired(uint32_t timer)
{
  uint32_t uDiff;
  int32_t sDiff;
...
/*******************************************************************************/
void RfalRfST25R95Class::timerDelay(uint16_t tOut)
{
  uint32_t t;
...
/*******************************************************************************/
void RfalRfST25R95Class::timerStopwatchStart(void)
{
...
/*******************************************************************************/
uint32_t RfalRfST25R95Class::timerStopwatchMeasure(void)
{
