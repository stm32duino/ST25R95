...
#include "st_errno.h"
#include "nfc_utils.h"
#include "rfal_rfst25r95_analogConfigTbl.h"
...
void RfalRfST25R95Class::rfalAnalogConfigInitialize(void)
{
...
bool RfalRfST25R95Class::rfalAnalogConfigIsReady(void)
{
  return gRfalAnalogConfigMgmt.ready;
}

ReturnCode RfalRfST25R95Class::rfalAnalogConfigListWriteRaw(const uint8_t *configTbl, uint16_t configTblSize)
{
...
ReturnCode RfalRfST25R95Class::rfalAnalogConfigListWrite(uint8_t more, const rfalAnalogConfig *config)
{
  // If Analog Configuration Update is to be disabled
  NO_WARNING(config);
  NO_WARNING(more);
...
ReturnCode RfalRfST25R95Class::rfalAnalogConfigListReadRaw(uint8_t *tblBuf, uint16_t tblBufLen, uint16_t *configTblSize)
{
...
ReturnCode RfalRfST25R95Class::rfalAnalogConfigListRead(rfalAnalogConfigOffset *configOffset, uint8_t *more, rfalAnalogConfig *config, rfalAnalogConfigNum numConfig)
{
  uint16_t configSize;
...
ReturnCode RfalRfST25R95Class::rfalSetAnalogConfig(rfalAnalogConfigId configId)
{
 ...
 *****************************************************************************
 */
rfalAnalogConfigNum RfalRfST25R95Class::rfalAnalogConfigSearch(rfalAnalogConfigId configId, uint16_t *configOffset)
{
